    ...
    return (
        <div className="flex items-center space-x-3">
            <button 
                ...
                className="inline-flex items-center px-4 py-2 bg-[var(--surface)] border border-[var(--border)] rounded-md font-medium text-[var(--text-muted)] hover:bg-[var(--bg)] shadow-sm text-sm transition-colors disabled:opacity-50"
            >
