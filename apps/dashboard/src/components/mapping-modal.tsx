...
setSelectedSkus([{ sku: product.articulo_id, name: product.nombre, marca: product.marca || '', modelo: product.modelo || '', variante: product.variante || '', codigo_universal: product.codigo_universal || '', caja_madre: product.caja_madre || '', quantity: 1, mapping_id: null }, ...selectedSkus]);
setSearchTerm('');
}
