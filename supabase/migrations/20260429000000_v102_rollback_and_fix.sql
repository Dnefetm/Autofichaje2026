-- =============================================================================
-- MIGRACIÓN v102: Rollback de tabla huérfana y fix de tabla canónica
-- =============================================================================
...
BEGIN
    ...
    -- Marcar como NO vigentes las listas anteriores del mismo proveedor
    ...
    -- Garantizar que la lista actual quede vigente
    UPDATE public.listas_precios_proveedor
       SET vigente = true
     WHERE importacion_id = p_importacion_id;
    ...
    VALUES (p_importacion_id, 'MATCHING_COMPLETO', 'Matching Set-Based con Ola 0 (Alias) y Fase 0 concluido.');
