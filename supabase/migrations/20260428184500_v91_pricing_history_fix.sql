-- Fix: correct column names in publication_pricing_history for V3 engine
BEGIN;

-- Add details column if we want to store the math explanation
ALTER TABLE publication_pricing_history ADD COLUMN IF NOT EXISTS details JSONB;
