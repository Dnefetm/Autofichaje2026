-- =============================================================================
-- MIGRACIÓN (append-only) Capa 0 — parte 7: rechazo persistente de vinculación
-- =============================================================================
-- Añade "Ignorar" persistente: tabla vinculacion_rechazos + la materialización
-- ahora clasifica esas filas como 'rechazado' (no salen en "propuestas").
-- =============================================================================
BEGIN;

CREATE TABLE IF NOT EXISTS public.vinculacion_rechazos (
...
-- Re-materialización ahora consciente del rechazo.
...
-- ROLLBACK:
-- DROP TABLE IF EXISTS public.vinculacion_rechazos;
-- (re-aplicar la versión de fn_materializar_vinculacion de 0014)
