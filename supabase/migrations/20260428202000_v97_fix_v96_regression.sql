-- v97_fix_v96_regression.sql

-- 1) Restaurar la función de negocio fn_recalcular_precio_publicacion
--    + GUARDA de recursión DENTRO de ella, no solo en la función trigger.
...
-- 2) Función trigger que DELEGA en la función de negocio
...
-- 3) Recrear trigger asegurando que llamará a la función
